...
import { Popup, Cell, ResultPage, Button } from '@nutui/nutui-react-taro'
  ...
  return (
    <>
      ...
      <Popup
        ...
        style={{ height: '282px' }}
      >
        <View className="demo-content" style={contentStyle}>
          <ResultPage
            title="反馈标题"
        ...
        <View className="demo-actions" style={actionsStyle}>
