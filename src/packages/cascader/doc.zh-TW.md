...
| 屬性 | 說明 | 類型     | 默認值 |
|---------------------| --------------- | -------- | ------ |
| value | 選中值，受控 | `(number | string | undefined)[]`    | `-` |
| defaultValue | 默认選中值 | `(number | string | undefined)[]`    | `-` |
| options | 級聯數據 | `Array`    | `-`      |
...
| onLoad | 動態加載回調，開啟動態加載時生效 | Function | `-`      |
...
| --nutui-cascader-title-padding | 標題padding值 | `24px 20px 17px` |
| --nutui-cascader-title-font-size | 標題字號 | `18px` |
| --nutui-cascader-title-line-height |標題行高 | `20px` |
