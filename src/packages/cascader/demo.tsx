    ...
    <>
      <div className="demo">
        ...
        <Cell
          ...
          desc={value1 ? value1 : translated.addressTip1}
          onClick={() => {
        ...
        <Cell
          title={translated.addressTip}
          desc={value2 ? value2 : translated.addressTip1}
          onClick={() => {
        ...
        <Cell
          title={translated.addressTip}
          desc={value3 ? value3 : translated.addressTip1}
          onClick={() => {
        ...
        <Cell
          title={translated.addressTip}
          desc={value4 ? value4 : translated.addressTip1}
          onClick={() => {
        ...
        <Cell
          title={translated.addressTip}
          desc={value5 ? value5 : translated.addressTip1}
          onClick={() => {
