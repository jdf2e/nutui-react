...
| --nutui-popover-primary-text-color | 選項區的文字顏色 | `$title-color` |
| --nutui-popover-border-color | top、bottom、left 和 right 的箭頭顏色 | `$white` |
| --nutui-popover-divider-color | 選項區的底部 border 顏色 | `$divider-color` |
| --nutui-popover-disable-color | 選項禁用的顏色 | `$disable-color` |
