...
| \--nutui-badge-dot-width | badge 為圓點時，size 等於 normal 的寬度、高度、圓角 | `6px` |
| \--nutui-badge-dot-small-width | badge 為圓點時，size 等於 small 的寬度、高度、圓角 | `4px` |
| \--nutui-badge-dot-large-width | badge 為圓點時，size 等於 large 的寬度、高度、圓角 | `8px` |
