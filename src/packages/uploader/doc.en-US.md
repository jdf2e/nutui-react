...
| \--nutui-uploader-background | The background color of the uploaded image | `$background-color` |
| \--nutui-uploader-background-disabled | The background color of the disabled state of uploading images | `$background-color` |
