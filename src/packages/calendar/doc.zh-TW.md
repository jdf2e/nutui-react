...
| \--nutui-calendar-choose-background-color-disabled | 日歴不可選元素的選中時的背景色 | `rgba(191, 191, 191, 0.09)` |
| \--nutui-calendar-choose-disable-color | 日歴不可選元素的選中時的字色 | `$color-text-disabled` |
...
| \--nutui-calendar-sub-title-font-size | 日歴副標題字號 | `$font-size` |
