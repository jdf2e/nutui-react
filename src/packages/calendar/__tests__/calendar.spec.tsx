...
test('show-title prop', async () => {
    ...
    const canlendarTitle1 = container.querySelectorAll('.nut-calendar-header .calendar-title');
    ...
    const canlendarTitle2 = container.querySelectorAll('.nut-calendar-header .calendar-title');
...
test('choose event when click item', async () => {
    ...
    const calendarConfirmBtn = container.querySelectorAll('.calendar-confirm-btn')[0];
