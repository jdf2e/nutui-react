...
| \--nutui-calendar-choose-background-color-disabled | calendar choose but disable background color | `rgba(191, 191, 191, 0.09)` |
| \--nutui-calendar-choose-disable-color | calendar choose but disable color | `$color-text-disabled` |
