...
<Tabbar onSwitch={(child, idx) => {console.log(idx)}}>
    <TabbarItem title="首頁" icon={<Home width={18} height={18} />} />
    <TabbarItem title="分類" icon={<Category width={18} height={18} />} />
    <TabbarItem title="發現" icon={<Find width={18} height={18} />} />
    <TabbarItem title="購物車" icon={<Cart width={18} height={18} />} />
...
const App = () => (
  <Tabbar>
    <TabbarItem title="首頁" icon={<Home width={12} height={12} />} num="11" />
    <TabbarItem title="分類" icon={<Category width={12} height={12} />} />
    <TabbarItem title="發現" icon={<Find width={12} height={12} />} />
    <TabbarItem title="購物車" icon={<Cart width={12} height={12} />} num="110" />
