...
> = (props, ref) => {
  ...
  useEffect(() => {
    ...
    pickerRollerRef.current?.addEventListener('touchstart', touchStart, options)
    pickerRollerRef.current?.addEventListener('touchmove', touchMove, options)
    pickerRollerRef.current?.addEventListener('touchend', touchEnd, options)
    return () => {
      pickerRollerRef.current?.removeEventListener('touchstart', touchStart)
