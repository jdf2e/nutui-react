...
| \--nutui-collapse-item-font-size | fontSize | `$font-size` |
| \--nutui-collapse-item-line-height | lineHeight | `24px` |
| \--nutui-collapse-item-color | font color | `#666666` |
| \--nutui-collapse-item-disabled-color | disabled color | `$color-text-disable` |
...
| \--nutui-collapse-wrapper-content-font-size | content fontSize | `$font-size` |
