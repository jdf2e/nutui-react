...
| \--nutui-timeselect-title-background | title background | `$card-background-color` |
...
| \--nutui-timeselect-time-active-background | time active background | `$card-background-color-wrapper` |