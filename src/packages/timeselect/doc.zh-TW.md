...
| \--nutui-timeselect-title-font-size | title 字體大小 | `$font-size` |
...
| \--nutui-timeselect-date-font-size | date 字體大小 | `$font-size` |
...
| \--nutui-timeselect-time-color | time 字體顏色 | `$color-title` |
