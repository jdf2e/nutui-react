...
| \--nutui-timeselect-title-background | title 背景 | `$card-background-color` |
...
| \--nutui-timeselect-date-color | date 字体颜色 | `$text-color` |
...
| \--nutui-timeselect-time-active-background | time 激活背景 | `$card-background-color-wrapper` |