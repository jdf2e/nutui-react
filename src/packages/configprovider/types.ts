export type NutCSSVariables =
  ...
  | 'nutuiTimeselectTitleWidth'
  | 'nutuiTimeselectTitleHeight'
  | 'nutuiTimeselectTitleLineHeight'
  | 'nutuiTimeselectPannelBgColor'
  | 'nutuiTimeselectTimepannelTextColor'
  | 'nutuiTimeselectTimepannelFontSize'
  | 'nutuiTimeselectTimepannelCurBgColor'
  | 'nutuiTimeselectTimepannelCurTextColor'
  | 'nutuiTimeselectTimepannelWidth'
  | 'nutuiTimeselectTimepannelHeight'
  | 'nutuiTimeselectTimepannelPadding'
  | 'nutuiTimeselectTimedetailPadding'
  | 'nutuiTimeselectTimedetailItemWidth'
  | 'nutuiTimeselectTimedetailItemHeight'
  | 'nutuiTimeselectTimedetailItemLineHeight'
  | 'nutuiTimeselectTimedetailItemBgColor'
  | 'nutuiTimeselectTimedetailItemBorderRadius'
  | 'nutuiTimeselectTimedetailItemTextColor'
  | 'nutuiTimeselectTimedetailItemTextFontSize'
  | 'nutuiTimeselectTimedetailItemCurBgColor'
  | 'nutuiTimeselectTimedetailItemCurBorder'
  | 'nutuiTimeselectTimedetailItemCurTextColor'
  | 'nutuiTimeselectTimedetailTimeTextColor'
  | 'nutuiTimeselectTimedetailTimeFontSize'
  | 'nutuiTagPadding'
  | 'nutuiTagFontSize'
  | 'nutuiTagDefaultBorderRadius'
  | 'nutuiTagRoundBorderRadius'
  | 'nutuiTagDefaultBackgroundColor'
  | 'nutuiTagPrimaryBackgroundColor'
  | 'nutuiTagSuccessBackgroundColor'
  | 'nutuiTagDangerBackgroundColorPlain'
  | 'nutuiTagWarningBackgroundColor'
  | 'nutuiTagDefaultColor'
  | 'nutuiTagBorderWidth'
  | 'nutuiTagHeight'
  ...
  | 'nutuiPopoverMenuItemNameMargin'
  ...
  | 'nutuiSidenavbarSubTitleFontSize'
  | 'nutuiSidenavbarSubTitleRadius'
  | 'nutuiSidenavbarSubTitleBorder'
  | 'nutuiSidenavbarSubTitleWidth'
  | 'nutuiSidenavbarSubTitleHeight'
  | 'nutuiSidenavbarSubTitleTextLineHeight'
  | 'nutuiSidenavbarSubTitleTextColor'
  | 'nutuiSidenavbarItemTitleColor'
  | 'nutuiSidenavbarItemTitleBgColor'
  | 'nutuiSidenavbarItemHeight'
  | 'nutuiSidenavbarItemLineHeight'
  | 'nutuiSidenavbarItemFontSize'
