export type NutCSSVariables =
  ...
  | 'nutuiColorError'
  | 'nutuiColorErrorLight'
  | 'nutuiColorErrorPressed'
  | 'nutuiColorService'
  | 'nutuiColorServicePressed'
  | 'nutuiColorServiceBorder'
  | 'nutuiColorServiceText'
  | 'nutuiColorServiceBtnBg'
  | 'nutuiColorServiceBtnBgPressed'
  | 'nutuiColorServiceBtnBgDisabled'
  ...
  | 'nutuiButton44Height'
  | 'nutuiButton44Padding'
  | 'nutuiButton44FontSize'
  | 'nutuiFontSize15'
  | 'nutuiButton44BorderRadius'
  | 'nutuiButtonLargeHeight'
  | 'nutuiButtonLargePadding'
  | 'nutuiButtonLargeFontSize'
  | 'nutuiButtonLargeBorderRadius'
  | 'nutuiButton36Height'
  | 'nutuiButton36Padding'
  | 'nutuiButton36FontSize'
  | 'nutuiFontSize14'
  | 'nutuiButton36BorderRadius'
  ...
  | 'nutuiButtonDangerPressed'
  | 'nutuiButtonServiceColor'
  | 'nutuiButtonServiceBorderColor'
  | 'nutuiButtonServiceBackgroundColor'
  | 'nutuiButtonServiceDisabled'
  | 'nutuiButtonServicePressed'
  | 'nutuiButtonPrimaryLightColor'
  | 'nutuiButtonPrimaryLightBackgroundColor'
  | 'nutuiButtonPrimaryLightBorderColor'
  ...
  | 'nutuiInputFontSize'
  | 'nutuiInputErrorColor'
  | 'nutuiInputPlainHeight'
  ...
  | 'nutuiActionsheetTitleColor'
  | 'nutuiActionsheetTitleFontSize'
  | 'nutuiActionsheetDescriptionColor'
  | 'nutuiActionsheetDescriptionFontSize'
  | 'nutuiActionsheetGridPadding'
  | 'nutuiActionsheetGridGap'
  | 'nutuiActionsheetGridItemWidth'
  | 'nutuiActionsheetGridTextColor'
  | 'nutuiActionsheetGridTextFontSize'
  | 'nutuiActionsheetGridTextLineHeight'
  ...
  | 'nutuiStepsBaseHeadBackgroundColor'
  | 'nutuiStepsBaseHeadBorder'
  | 'nutuiStepsBaseHeadTextSize'
  | 'nutuiStepsBaseIconSize'
  | 'nutuiStepsBaseHeadColor'
  | 'nutuiStepsBaseHeadDotSize'
  | 'nutuiStepsBaseHeadDotBackgroundColor'
  | 'nutuiStepsBaseHeadIconSize'
  | 'nutuiStepsBaseHeadIconSizeRight'
  | 'nutuiStepsVerticalItemIconSize'
  ...
  | 'nutuiStepsBaseHeadBorderColor'
  | 'nutuiStepsProcessHeadBackgroundColor'
  | 'nutuiStepsProcessColor'
  ...
  | 'nutuiStepsBusinessTitleColor'
  | 'nutuiStepsBusinessDescriptionColor'
  | 'nutuiStepsBusinessHeadTextColor'
  | 'nutuiStepsBusinessHeadDotBackgroundColor'
  | 'nutuiStepsBusinessHeadIconColor'
  | 'nutuiStepsBusinessHeadBackgroundColor'
  | 'nutuiStepsEnhancedFinishHeadBackgroundColor'
  | 'nutuiStepsEnhancedFinishHeadDotBackgroundColor'
  | 'nutuiStepsEnhancedFinishHeadIconColor'
  | 'nutuiStepsEnhancedFinishHeadTextColor'
  | 'nutuiStepsHorizontalItemPaddingRight'
  | 'nutuiStepsHorizontalItemLinePadding'
  | 'nutuiStepsHorizontalItemSpecialPaddingRight'
  | 'nutuiStepsHorizontalItemSpecial3PaddingRight'
  | 'nutuiStepsVerticalItemPaddingBottom'
  | 'nutuiStepsVerticalTitleFontSize'
  | 'nutuiStepsVerticalTitleMarginBottom'
  | 'nutuiStepsVerticalLineHeight'
  | 'nutuiStepsVerticalDescriptionFontSize'
  | 'nutuiStepsVerticalDescriptionMargin'
  | 'nutuiDialogMinWidth'
  | 'nutuiDialogWidth'
  | 'nutuiDialogPadding'
  ...
  | 'nutuiDialogFooterBadgeHeight'
  | 'nutuiDialogFooterBadgeFontsize'
  | 'nutuiDialogFooterBadgePadding'
  | 'nutuiDialogFooterBadgeTop'
  | 'nutuiDialogFooterBadgeBorderRadius'
  | 'nutuiDialogFooterBadgeBgOk'
  | 'nutuiDialogFooterBadgeColorOk'
  | 'nutuiDialogFooterBadgeBgCancel'
  | 'nutuiDialogFooterBadgeColorCancel'
  ...
  | 'nutuiDialogBottomCloseIconSize'
  | 'nutuiDialogCloseTop'
  ...
  | 'nutuiBlack5'
  | 'nutuiPaginationCapsuleBackgroundColor'
  | 'nutuiPaginationCapsuleColor'
  | 'nutuiPaginationCapsuleRadius'
  | 'nutuiPaginationCapsulePadding'
  | 'nutuiPaginationCapsuleFontSize'
  | 'nutuiPaginationTextColor'
  | 'nutuiPaginationTextFontSize'
  | 'nutuiPaginationTextFontWeight'
  | 'nutuiPaginationProgressHeight'
  | 'nutuiPaginationProgressGap'
  | 'nutuiPaginationProgressActiveColor'
  | 'nutuiPaginationProgressInactiveColor'
  | 'nutuiWhite3'
  ...
  | 'nutuiIndicatorDotBorder'
  | 'nutuiIndicatorDotInactiveColor'
  | 'nutuiIndicatorTrackWidth'
  | 'nutuiIndicatorSliderWidth'
  | 'nutuiIndicatorDualScreenInactiveWidth'
  | 'nutuiIndicatorPlacementGap'
  | 'nutuiIndicatorPlacementSafeGap'
  ...
  | 'nutuiSidebarBackgroundColor'
  | 'nutuiSidebarBorderRadius'
  | 'nutuiSidebarWidth'
  | 'nutuiSidebarMaxWidth'
  | 'nutuiSidebarTitleHeight'
  | 'nutuiSidebarInactiveFontSize'
  | 'nutuiSidebarActiveFontSize'
  | 'nutuiSidebarActiveFontWeight'
  ...
  | 'nutuiElevatorListItemCodeWidth'
  ...
  | 'nutuiQuickenterBgColor'
  | 'nutuiQuickenterMaxHeight'
  | 'nutuiQuickenterTitleFontSize'
  | 'nutuiQuickenterTitleColor'
  | 'nutuiQuickenterItemTitleFontSize'
  | 'nutuiQuickenterItemTitleColor'
  | 'nutuiQuickenterItemIconBgColor'
  ...
  | 'nutuiToastInnerMinWidth'
  | 'nutuiToastInnerMaxWidth'
  | 'nutuiToastInnerHasIconMinWidth'
  | 'nutuiToastInnerHasIconMaxWidth'
  | 'nutuiWhite'
  ...
  | 'nutuiIndicatorTotal'
  | 'nutuiButtonDisabledBackgroundColor'
  | 'nutuiBlack1'
