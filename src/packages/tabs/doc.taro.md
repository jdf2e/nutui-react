...
| \--nutui-tabs-titles-font-size | Tab 标题的字号 | `$font-size` |
| \--nutui-tabs-title-gap | Tab 标题的左右 margin | `0px` |
| \--nutui-tabs-titles-item-active-font-weight | Tab 选中标题的字重 | `600` |
| \--nutui-tabs-tab-line-color | 水平方向线条颜色 | `linear-gradient(90deg, $color-primary 0%, rgba(#fa2c19, 0.15) 100%)` |
| \--nutui-tabs-line-bottom | 水平方向线条距离 | `15%` |
| \--nutui-tabs-line-border-radius | 水平方向线的圆角 | `0px` |
| \--nutui-tabs-tab-line-opacity | 水平方向线的透明度 | `1` |
| \--nutui-tabs-titles-height | 水平方向标题的高度 | `46px` |
...
| \--nutui-tabs-tab-line-width | 水平方向激活选项卡线条的宽度 | `40px` |
| \--nutui-tabs-tab-line-height | 水平方向激活选项卡线条的高度 | `3px` |
