...
| 名称 | 说明 | 默认值 |
| --- | --- | --- |
| \--nutui-form-item-error-line-color | 错误信息边框颜色 | `$primary-color` |
| \--nutui-form-item-required-color | 必选标识的字体颜色 | `$primary-color` |
| \--nutui-form-item-error-message-color | 错误信息的文本颜色 | `$primary-color` |
