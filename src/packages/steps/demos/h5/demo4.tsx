...
const customTheme = {
  ...
  nutuiSpaceGap: '20px',
  nutuiStepsProcessTitleColor: '#0acc2a',
  nutuiStepsProcessDescriptionColor: '#0acc2a',
  nutuiStepsProcessLineColor: '#0acc2a',
  nutuiStepsProcessHeadBackgroundColor: '#0acc2a',
