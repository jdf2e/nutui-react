...
- 📖 Based on JD APP 16.0 visual specification
...
| --- | --- | --- | --- |
| @nutui/nutui-react <img src="https://img.shields.io/npm/v/@nutui/nutui-react" /> | React 17\18 | Jingdong APP 16.0 | Modern browsers start with Chrome >= 51、iOS >= 10.0 |
