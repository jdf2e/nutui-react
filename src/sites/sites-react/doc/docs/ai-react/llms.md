...
我们支持 [LLMs.txt](https://llmstxt.org/) 规范，将 NutUI-React 的文档以对大语言模型(LLM)友好的形式提供出来。借助这些文件，Cursor、GitHub Copilot、Claude 等 AI 工具能够更准确地理解我们的组件库、API 与用法，减少「幻觉」式的错误代码。
