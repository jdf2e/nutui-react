...
import { routes as routers, guideEnTaroRoutes, guideTaroRoutes, aiTaroRoutes } from './router'
...
const Content = () => {
  ...
  const routes = [...routers, ...guideTaroRoutes, ...guideEnTaroRoutes, ...aiTaroRoutes]
  return (
