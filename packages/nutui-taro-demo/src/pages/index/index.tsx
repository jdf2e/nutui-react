...
import { View, Image, Swiper, SwiperItem, Text, ScrollView, Button, Input, Video, Form } from '@tarojs/components'
...
console.log(Button, Input, Video,Image, Swiper, SwiperItem, Form )
