  ...
  return (
    <>
      ...
      Taro.getEnv() !== Taro.ENV_TYPE.HARMONYHYBRID && Taro.getEnv() !== 'RN' ? (
        ...
        <>
          <View>{translated['84aa6bce']}</View>
          <Demo1 />
          <View>{translated.abbf9359}</View>
          <Demo2 />
          <View>{translated.duration}</View>
          <Demo3 />
          <View>{translated.lockscroll}</View>
          <Demo4 />
          <View>{translated.ec0d7acf}</View>
          <Demo5 />
          <View>{translated.closeClickLay}</View>
          <Demo6 />
        </>
      )}
    </>
