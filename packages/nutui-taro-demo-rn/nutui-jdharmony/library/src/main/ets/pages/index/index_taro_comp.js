...
const scripts = {
	...
	"dev:taro:weapp": "pnpm --dir ./packages/nutui-taro-demo-rn dev:weapp",
	"dev:taro:jd": "pnpm --dir ./packages/nutui-taro-demo-rn dev:jd",
	"build:taro:jd": "pnpm --dir ./packages/nutui-taro-demo build:jd",
	"dev:taro:h5": "pnpm --dir ./packages/nutui-taro-demo-rn dev:h5",
	...
	"dev:taro:harmony": "pnpm --dir ./packages/nutui-taro-demo-rn dev:harmony",
	"dev:taro:jdharmony": "pnpm --dir ./packages/nutui-taro-demo-rn dev:jdharmony",
...
var Index = function Index2() {
  var gotoNext = function gotoNext2(name, enName) {
    console.log("test111", "/".concat(enName, "/pages/").concat(name.toLocaleLowerCase(), "/index"));
    Taro.navigateTo({
