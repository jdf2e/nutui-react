...
import { C as Cell, b as _slicedToArray, c as ConfigProvider, u as useTranslate, H as Header } from '../../../index.taro.js';
...
var Demo3 = function Demo32() {
  var overlimit = function overlimit2() {
  ...
  var _useState3 = useState(""),
    ...
    _useState4[0];
    var SetToastMsg = _useState4[1];
  var _useState5 = useState("text"),
    _useState6 = _slicedToArray(_useState5, 2);
    _useState6[0];
    var SetToastType = _useState6[1];
  var toastShow = function toastShow2(msg, type) {
    SetToastMsg(msg);
    SetToastType(type);
    SetShow(true);
  };
...
var Demo8 = function Demo82() {
  ...
  var _useState5 = useState(""),
    _useState6 = _slicedToArray(_useState5, 2);
    _useState6[0];
    var SetToastMsg = _useState6[1];
  var _useState7 = useState("text"),
    _useState8 = _slicedToArray(_useState7, 2);
    _useState8[0];
    var SetToastType = _useState8[1];
  var toastShow = function toastShow2(msg, type) {
    SetToastMsg(msg);
    SetToastType(type);
    SetShow(true);
    ...
    children: [/* @__PURE__ */jsx(Cell, {
      children: /* @__PURE__ */jsx(ConfigProvider, {
        ...
        children: /* @__PURE__ */jsx(InputNumber, {
          ...
          __styleSheet: {
            key: "format-width",
            value: calcStaticStyle(__inner_style__$1(), "format-width")
          },
          __hmStyle: calcStaticStyle(__inner_style__$1(), "format-width")
        })
      })
    }), /* @__PURE__ */jsx(Cell, {
      children: /* @__PURE__ */jsx(ConfigProvider, {
...
var InputNumberDemo = function InputNumberDemo2() {
...
const index = (function () {
  return createNativePageConfig(InputNumberDemo, 'dentry/pages/inputnumber/index', React, ReactDOM, config);
});
