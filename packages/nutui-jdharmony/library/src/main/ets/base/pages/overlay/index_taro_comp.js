...
import { b as _slicedToArray, C as Cell, p as pxTransform, u as useTranslate, H as Header, a as harmonyAndRn } from '../../../index.taro.js';
...
var Demo2 = function Demo22() {
  ...
  var handleToggleShow = function handleToggleShow2() {
    setVisible(true);
  };
...
var Demo3 = function Demo32() {
  ...
  return __combine_nesting_style__( /* @__PURE__ */jsxs(Fragment, {
    children: [/* @__PURE__ */jsx(Cell, {
      ...
      onClick: onClose,
      style: {
        "--nutui-overlay-animation-duration": "2.5s"
      },
      duration: 2500,
...
var OverlayDemo = function OverlayDemo2() {
  ...
  return __combine_nesting_style__( /* @__PURE__ */jsxs(Fragment, {
    children: [/* @__PURE__ */jsx(Header, {}), !harmonyAndRn() ? /* @__PURE__ */jsxs(TaroViewTagName, {
      __hmStyle: calcStaticStyle(__inner_style__(), "demo ".concat(Taro.getEnv() === "WEB" ? "web" : "", " demo-overlay")),
      className: "demo ".concat(Taro.getEnv() === "WEB" ? "web" : "", " demo-overlay"),
      children: [/* @__PURE__ */jsx(TaroViewTagName, {
...
const index = (function () {
  return createNativePageConfig(OverlayDemo, 'base/pages/overlay/index', React, ReactDOM, config);
});
