...
import { C as Cell, I as Indicator, a as harmonyAndRn, p as pxTransform, c as ConfigProvider, u as useTranslate, b as _slicedToArray, H as Header } from '../../../index.taro.js';
...
var IndicatorDemo = function IndicatorDemo2() {
  ...
  return __combine_nesting_style__( /* @__PURE__ */jsxs(Fragment, {
    children: [/* @__PURE__ */jsx(Header, {}), /* @__PURE__ */jsxs(TaroScrollViewTagName, {
      ...
      children: [/* @__PURE__ */jsx(TaroViewTagName, {
        ...
        __hmStyle: calcStaticStyle(__inner_style__(), "h2"),
        className: "h2",
        children: translated.customNode
      }), /* @__PURE__ */jsx(Demo2, {}), /* @__PURE__ */jsx(TaroViewTagName, {
        __hmStyle: calcStaticStyle(__inner_style__(), "h2"),
        className: "h2",
        children: translated.custom
      }), Taro.getEnv() === "RN" ? null : /* @__PURE__ */jsx(Demo3, {}), /* @__PURE__ */jsx(TaroViewTagName, {
        __hmStyle: calcStaticStyle(__inner_style__(), "h2"),
        className: "h2",
...
const index = (function () {
  return createNativePageConfig(IndicatorDemo, 'exhibition/pages/indicator/index', React, ReactDOM, config);
});
