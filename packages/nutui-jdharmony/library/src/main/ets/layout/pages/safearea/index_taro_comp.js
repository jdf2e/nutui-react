...
import { u as useTranslate, b as _slicedToArray, H as Header } from '../../../index.taro.js';
import Taro from '@jd-oh/taro_library/src/main/ets/npm/@tarojs/taro';
import { TaroViewTagName, TaroTextTagName } from '@jd-oh/taro_library/src/main/ets/npm/@tarojs/components/tag';
...
function generateRandomTextArray(count) {
  ...
  for (var j = 0; j < count; j++) {
    var randomLength = Math.floor(Math.random() * 5) + 4;
    var randomText = "";
...
var Demo1 = function Demo12() {
  return __combine_nesting_style__( /* @__PURE__ */jsxs(TaroViewTagName, {
    children: [/* @__PURE__ */jsx(TaroTextTagName, {
      children: generateRandomTextArray(900).join(" ")
...
var SafeAreaDemo = function SafeAreaDemo2() {
  ...
  return __combine_nesting_style__( /* @__PURE__ */jsxs(TaroViewTagName, {
    children: [/* @__PURE__ */jsx(Header, {}), /* @__PURE__ */jsxs(TaroViewTagName, {
...
const index = (function () {
  return createNativePageConfig(SafeAreaDemo, 'layout/pages/safearea/index', React, ReactDOM, config);
});
