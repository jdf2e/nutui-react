...
import { C as Cell, b as _slicedToArray, u as useTranslate, H as Header } from '../../../index.taro.js';
...
var Demo2 = function Demo22() {
  var _useState = useState(true),
    ...
    checkedAsync = _useState2[0],
    setCheckedAsync = _useState2[1];
  var onChangeAsync = function onChangeAsync2(value, event) {
    Taro.showToast({
      title: "2秒后异步触发 ".concat(value)
    });
    setTimeout(function () {
...
var Demo4 = function Demo42() {
  var _onChange = function onChange(value, event) {
    Taro.showToast({
      title: "触发了onChange事件，开关状态：".concat(value)
    });
  };
  return __combine_nesting_style__( /* @__PURE__ */jsx(Cell, {
    children: /* @__PURE__ */jsx(Switch, {
...
var SwitchDemo = function SwitchDemo2() {
  ...
  return __combine_nesting_style__( /* @__PURE__ */jsxs(Fragment, {
    children: [/* @__PURE__ */jsx(Header, {}), /* @__PURE__ */jsxs(TaroScrollViewTagName, {
      ...
      children: [/* @__PURE__ */jsx(TaroViewTagName, {
        ...
        __hmStyle: calcStaticStyle(__inner_style__(), "h2"),
        className: "h2",
        children: translated.asyncControl
        ...
        __hmStyle: calcStaticStyle(__inner_style__(), "h2"),
        className: "h2",
        children: translated.supportText
      }), /* @__PURE__ */jsx(Demo6, {})]
    })]
  }), __nesting_style__());
};
...
const index = (function () {
  return createNativePageConfig(SwitchDemo, 'dataentry/pages/switch/index', React, ReactDOM, config);
});
